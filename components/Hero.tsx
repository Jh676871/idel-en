...
export function Hero() {
  return (
    <section className="relative min-h-[calc(100svh-4rem)] md:min-h-[70vh] flex flex-col justify-between items-center text-center px-4 overflow-hidden pt-10 pb-10">
      ...
      >
        <span className="block glitch glitch-hero" data-text="和 I-DLE 一起">
          和 <span className="glitch-rgb" data-text="I-DLE">I-DLE</span> 一起
        </span>
        <span className="mt-2 block glitch glitch-hero" data-text="閃耀舞台！">
      ...
      >
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 -z-10 h-[240px] w-[min(560px,120%)] blur-2xl opacity-95 bg-[radial-gradient(closest-side,rgba(0,0,0,0.72),rgba(0,0,0,0.0)_72%)]" />
      ...
      <a
        href="#members"
        className="text-sm sm:text-base font-orbitron tracking-widest text-white/80 hover:text-white transition-colors"
      >
