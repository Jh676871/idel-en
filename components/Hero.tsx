...
export function Hero() {
  return (
    <section className="relative min-h-[calc(100svh-4rem-3.5rem)] md:min-h-[70vh] flex flex-col items-center text-center px-4 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center w-full">
        <div className="w-full max-w-3xl translate-y-[4vh] sm:translate-y-[2vh] md:translate-y-0">
          <motion.h1
      ...
      <a
        href="#members"
        className="absolute left-1/2 -translate-x-1/2 bottom-8 md:bottom-12 text-xs sm:text-sm md:text-base font-orbitron tracking-widest text-white/80 hover:text-white transition-colors"
      >
